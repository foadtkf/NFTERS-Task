...
const Footer = () => {
  return (
    <footer className="px-[10%] flex flex-wrap justify-between">
      <div className="md:w-[50%] lg:w-[33%]">
        ...
        <div className="flex justify-between w-[30%] mt-4">
          <p>
            <BsFacebook className="link link-hover] no-underline hover:no-underline   text-[30px] text-indigo-800" />
          </p>
          <p>
            <AiFillTwitterCircle className="link link-hover] no-underline hover:no-underline rounded-full overflow-hidden text-[35px] text-blue-400" />
          </p>
          <p>
            <BsLinkedin className="link link-hover] no-underline hover:no-underline rounded-full overflow-hidden text-[32px] text-sky-600" />
          </p>
        </div>
      </div>
      <div>
