  ...
  return (
    ...
    >
      <div className="navbar-start">
        ...
        <div class="pt-0 relative mx-auto text-gray-600 lg:hidden">
          <input
            class="border-2 border-gray-300 bg-white h-6 pl-1 rounded-full text-xs focus:outline-none"
            type="search"
            name="search"
            placeholder="Search"
          />
    ...
    // <div className="drawer   fixed bg-base-100">
